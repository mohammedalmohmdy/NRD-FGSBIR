"""
ShoeV2 Dataset Loader for Neural Retrieval Dynamics (NRD)
This module implements the dataset loader for the ShoeV2 dataset.
"""
...
class ShoeV2Dataset(BaseDataset):
    """
    Dataset loader for ShoeV2 dataset.
    
    The ShoeV2 dataset contains sketch-photo pairs of shoes.
    ...
    Args:
        data_root (str): Root directory of the ShoeV2 dataset
...
def create_shoev2_dataset(
    ...
    """
    Create a ShoeV2 dataset with default transforms.
    ...
    Returns:
        ShoeV2Dataset: Configured dataset
    """
